...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x48000294u)

/* IOPINS0_8 Address: CYREG_PRT15_DM0 Size (bytes): 8 */
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x4800029Cu)

/* IOPINS0_3 Address: CYREG_PRT3_DM0 Size (bytes): 8 */
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x480002A4u)

/* IOPINS0_4 Address: CYREG_PRT4_DM0 Size (bytes): 8 */
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x480002ACu)

/* IOPINS0_5 Address: CYREG_PRT5_DM0 Size (bytes): 8 */
#define BS_IOPINS0_5_VAL ((const uint8 CYFAR *)0x480002B4u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_DSM0_SW0, 0x12u);
...
uint8 CYXDATA * const CYCODE OutMux__addrTable[8] = {
	(uint8 CYXDATA *)CYREG_DAC3_SW0, (uint8 CYXDATA *)CYREG_BUS_SW0, 
	(uint8 CYXDATA *)CYREG_DAC1_SW0, (uint8 CYXDATA *)CYREG_BUS_SW0, 
	(uint8 CYXDATA *)CYREG_DAC0_SW0, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_DAC2_SW0, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
};

/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE OutMux__maskTable[8] = {
	0x10u, 0x10u, 
	0x02u, 0x02u, 
	0x02u, 0x00u, 
	0x10u, 0x00u, 
...
*
*******************************************************************************/
void OutMux_Set(uint8 channel)
{
	if (channel < 4)
	{
		channel += channel;
		*OutMux__addrTable[channel] |= OutMux__maskTable[channel];
		channel++;
		*OutMux__addrTable[channel] |= OutMux__maskTable[channel];
	}
}
...
*
*******************************************************************************/
void OutMux_Unset(uint8 channel)
{
	if (channel < 4)
	{
		channel += channel;
		*OutMux__addrTable[channel] &= (uint8)~OutMux__maskTable[channel];
		channel++;
		*OutMux__addrTable[channel] &= (uint8)~OutMux__maskTable[channel];
	}
}
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
uint8 CYXDATA * const CYCODE Pot_Vals__addrTable[4] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE Pot_Vals__maskTable[4] = {
	0x40u, 0x40u, 
	0x80u, 0x80u, 
};

/*******************************************************************************
* Function Name: Pot_Vals_Set
********************************************************************************
* Summary:
*  This function is used to set a particular channel as active on the AMux.
*
...
*
*******************************************************************************/
void Pot_Vals_Set(uint8 channel)
{
	if (channel < 2)
	{
		channel += channel;
		*Pot_Vals__addrTable[channel] |= Pot_Vals__maskTable[channel];
		channel++;
		*Pot_Vals__addrTable[channel] |= Pot_Vals__maskTable[channel];
	}
}
...
*
*******************************************************************************/
void Pot_Vals_Unset(uint8 channel)
{
	if (channel < 2)
	{
		channel += channel;
		*Pot_Vals__addrTable[channel] &= (uint8)~Pot_Vals__maskTable[channel];
		channel++;
		*Pot_Vals__addrTable[channel] &= (uint8)~Pot_Vals__maskTable[channel];
	}
}
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
uint8 CYXDATA * const CYCODE Tremolo__addrTable[4] = {
	(uint8 CYXDATA *)CYREG_PRT15_AG, (uint8 CYXDATA *)CYREG_SC0_SW0, 
	(uint8 CYXDATA *)CY_AMUX_UNUSED, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
};

/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE Tremolo__maskTable[4] = {
	0x10u, 0x01u, 
	0x00u, 0x00u, 
};

/*******************************************************************************
* Function Name: Tremolo_Set
********************************************************************************
* Summary:
*  This function is used to set a particular channel as active on the AMux.
*
...
*
*******************************************************************************/
void Tremolo_Set(uint8 channel)
{
	if (channel < 2)
	{
		channel += channel;
		*Tremolo__addrTable[channel] |= Tremolo__maskTable[channel];
		channel++;
		*Tremolo__addrTable[channel] |= Tremolo__maskTable[channel];
	}
}
...
*
*******************************************************************************/
void Tremolo_Unset(uint8 channel)
{
	if (channel < 2)
	{
		channel += channel;
		*Tremolo__addrTable[channel] &= (uint8)~Tremolo__maskTable[channel];
		channel++;
		*Tremolo__addrTable[channel] &= (uint8)~Tremolo__maskTable[channel];
	}
}
