...
#define Mixer_1_INIT_POWER                 (2u)
#define Mixer_1_LO_SOURCE                  (1u)
#define Mixer_1_EXTERNAL_LO_CLK_FREQ       ((float)0.002)
#define Mixer_1_VddaVal                    (5u)

#if (Mixer_1_LO_SOURCE == Mixer_1_LO_SOURCE_INTERNAL)
    /* Internal LO clock frequency */
    #define Mixer_1_LO_CLOCK_FREQ          ((float)4000)
#else
    #define Mixer_1_LO_CLOCK_FREQ          (((float)0.002 == \
                                                      Mixer_1_UNKNOWN_EXTERNAL_LO) ? \
                                                      ((float)4000) : ((float)0.002))
